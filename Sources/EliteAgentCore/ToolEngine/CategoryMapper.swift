...
public struct CategoryMapper {
    ...
    private static let categoryMap: [TaskCategory: [String]] = [
        ...
        .applicationAutomation: ["media_control", "apple_calendar", "apple_mail", "shortcut_execution", "discover_shortcuts", "send_message_via_whatsapp_or_imessage", "system_date", "timer_set"],
